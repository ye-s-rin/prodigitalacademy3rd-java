...
public class Report {
    ...
    public void report(Writer out, List<Machine> machines, Robot robot) throws IOException {
    	printTitle(out);
        printMachinesStatus(out, machines);
		robot.printRobotStatus(out);
		printFooter(out);
	}
	...
	private void printMachinesStatus(Writer out, List<Machine> machines) throws IOException {
		for ( Machine machine : machines) {
			machine.printMachineStatus(out);
		}
